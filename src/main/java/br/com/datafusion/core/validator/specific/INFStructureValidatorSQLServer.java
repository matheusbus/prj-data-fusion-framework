 ...
 * @author Matheus
 */
public class INFStructureValidatorSQLServer extends INFStructureValidatorRelational {

    public INFStructureValidatorSQLServer(INFConnectionType connectionType, String schemaName, String tableName) throws Exception {
